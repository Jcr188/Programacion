...
public class Sistema {
    public static void main(String[] args) {
        ...
        System.err.println("¿Cual es el nombre del trabajador?:");
        ...
        System.out.println("¿Cúal es la clave del trabajador:?");
        ...
        if (clave == 1) {
            if (antiguedad == 1) {
                ...
                System.out.println("Error, la clave de departameto es incorrecto");
            }
